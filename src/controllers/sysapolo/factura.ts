    ...
    if (resultDB.length > 0) {
      ...
      if (clientSysDBArray.length > 0) {
        ...
        let tercero: ClienteSysApolo = {
          ...
          seg_apellido: (cliente.ape2_persona==null) ? '' : cliente.ape2_persona.substring(0,15) || '',
          pri_nombre: cliente.nom1_persona.substring(0,15),
          otr_nombre: (cliente.nom2_persona==null) ? '' : cliente.nom2_persona.substring(0,15) || '',
          dir_ter: (cliente.dir_persona ==null)  ? '' :cliente.dir_persona.substring(0,100) || '',
          tel_ter: (cliente.cel_persona ==null)  ? '' : cliente.cel_persona.substring(0,40) || '',
          email: (cliente.email_persona ==null)  ? '' : cliente.email_persona.substring(0,100)  || '',

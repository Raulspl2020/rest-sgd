export class ResponsePago {
  ...
  constructor(params: any) {
    ...
    this._str_descripcion = params.str_descripcion
      ? params.str_descripcion
      : "";
    ...
    this._str_nombre_banco = params.str_nombre_banco
      ? params.str_nombre_banco
      : "";
    this._str_codigo_transacción = params.str_codigo_transacción
      ? params.str_codigo_transacción
      : "";
  ...
  getOjectResponse() {
    return {
      ...
      int_codigo_servicio: this._int_codigo_servicio
        ? this._int_codigo_servicio
        : null,
      ...
      str_codigo_transacción: this._str_codigo_transacción
        ? this._str_codigo_transacción
        : null,
      int_ciclo_transacción: this._int_ciclo_transacción
        ? this._int_ciclo_transacción
        : null,
      int_numero_tarjeta: this._int_numero_tarjeta
        ? this._int_numero_tarjeta
        : null,
      str_franquicia: this._str_franquicia ? this._str_franquicia : null,
      int_cod_aprobacion: this._int_cod_aprobacion
        ? this._int_cod_aprobacion
        : null,
